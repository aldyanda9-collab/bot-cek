...
# ============================================================
# ⚙️ KONFIGURASI — BACA DARI ENVIRONMENT VARIABLE
# ============================================================
BOT_TOKEN    = os.environ.get("BOT_TOKEN", "8085735680:AAF8mG_XA3UJ8-qOv0ObYOtnmOvSDzxFBcw")
ADMIN_IDS    = [6551372143]
HARGA_LANGGANAN = "10.000"
NAMA_REKENING   = "SEABANK / 901954431148 NURASIAH"
KONTAK_ADMIN    = "@Lsyaa_35"
...
API_ID   = int(os.environ.get("API_ID", "30711907"))
API_HASH = os.environ.get("API_HASH", "357d56079f349b0e18a1b7089788187d")
PHONE    = os.environ.get("PHONE", "+6289506555439")
...
# Pakai StringSession jika ada, fallback ke file session
if SESSION_STRING:
    telethon_client = TelegramClient(StringSession(SESSION_STRING), API_ID, API_HASH)
else:
    telethon_client = TelegramClient("sangmata_session", API_ID, API_HASH)
